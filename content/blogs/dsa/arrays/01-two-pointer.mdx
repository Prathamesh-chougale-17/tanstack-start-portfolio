...
- https://leetcode.com/problems/two-sum-ii-input-array-is-sorted/ - classic sorted pair problem
- https://leetcode.com/problems/valid-palindrome/ - left-right character checks

#### Medium

- https://leetcode.com/problems/container-with-most-water/ - best area using both ends
- https://leetcode.com/problems/3sum/ - two pointer inside a sorted loop

#### Hard

- https://leetcode.com/problems/trapping-rain-water/ - can be solved with two pointers
