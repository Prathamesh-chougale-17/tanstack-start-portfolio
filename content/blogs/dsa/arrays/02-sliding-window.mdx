...
- https://leetcode.com/problems/maximum-average-subarray-i/ - fixed-size window

#### Medium

- https://leetcode.com/problems/minimum-size-subarray-sum/ - classic variable window
- https://leetcode.com/problems/longest-repeating-character-replacement/ - count-based window

#### Hard

- https://leetcode.com/problems/minimum-window-substring/ - advanced frequency window
